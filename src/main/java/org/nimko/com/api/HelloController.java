...
public class HelloController {
  ...
  @GetMapping(value = "/oleksandr_nimko_ml_cv", produces = MediaType.TEXT_HTML_VALUE)
  public String oleksandr_nimko_ml_cv() throws IOException {
    return new ClassPathResource(CV_OLEKSANDR_ML_PAGE)
        .getContentAsString(StandardCharsets.UTF_8);
  }
}
