...
@Service
@Order(1)
public class HelloCommand implements CommandProcess {

  private final I18nService i18nService;

  public HelloCommand(final I18nService i18nService) {
  ...
  public ReplyData execute(final String normalizedText, final boolean hasPhoto, final byte[] imageBytes,
    ...
    return new ReplyData(i18nService.getTranslate("bot.hello"), false);
  }
}
